...
# CATEGORY: Age
# TITLE: Australian Tax Return Income by Age Group (3D)
# AUTHOR: George Paw
# DATE: November 2017
...
def ATO_AG_3(df):
    ...
    for age_col in range(0, len(list(ATO_helper.age_group.values()))):
        ...
        traces[age_col] = go.Surface(
            ...
            colorscale=[
                [0, 'rgb(255, 0, 0)'],        #0
                [1./10000, 'rgb(200, 50, 60)'], #10
                [1./1000, 'rgb(150, 100, 180)'],  #100
                [1./100, 'rgb(100, 150, 120)'],   #1000
                [1./10, 'rgb(50, 200, 60)'],       #10000
                [1., 'rgb(0, 255, 0)'],             #100000
            ]
    ...
    data = traces
    layout = go.Layout(
        title='Australian Tax Return Income<br>by Age Group (3D)',
        autosize=True,
        scene=dict(
            ...
            zaxis=dict(title="Percentage of Age Group Population", type="-")
        ),
